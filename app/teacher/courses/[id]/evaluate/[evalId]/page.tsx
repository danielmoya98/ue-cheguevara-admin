...
export default async function TeacherEvaluatePage(props: { params: Promise<{ id: string, evalId: string }> }) {
    // Desestructuramos los parámetros de la URL de forma segura (Next.js 15+)
    ...
    try {
        ...
        return (
            <div className="p-16 text-center border-4 border-dashed border-red-300 bg-white">
                ...
                <span className="text-xs font-bold text-gray-500 uppercase block mb-6">El examen solicitado no existe o fue eliminado.</span>
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 relative">
            ...
            <div className="border-b-4 border-uecg-black pb-6">
                <Link
                    // El botón de volver apunta inteligentemente a la vista del profesor
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-4 text-xs font-bold uppercase tracking-widest text-uecg-gray mt-3">
                                <span className="flex items-center gap-1.5"><Calendar size={14} strokeWidth={2.5} /> {evaluation.date.toLocaleDateString('es-BO')}</span>
